...
public class AddSalesReceiptTransactionTest {
	...
	public void testAddSalesReceipt() {
		int employeeId = 2;
		AddCommissionedEmployeeTransaction addCommissionedEmployee = new AddCommissionedEmployeeTransaction(employeeId,
				"Bill", "Home", 15.25, 0.5);
		addCommissionedEmployee.execute();

		Calendar date = new GregorianCalendar(2001, 11, 31);
		Transaction salesReceiptTransaction = new AddSalesReceiptTransaction(date, 1000, employeeId);
		...
		SalesReceipt receipt = commissionedClassification.getSalesReceipt(date);
